...
"[project]/Desktop/calaya-taskly/src/views/dashboards/HOD/HODDocuments.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/* ---------- UI helpers ---------- */ const Card = ({ className = "", children })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/Desktop/calaya-taskly/src/views/dashboards/HOD/HODDocuments.jsx",
        lineNumber: 15,
        columnNumber: 3
    }, ("TURBOPACK compile-time value", void 0));
_c = Card;
...
function HODDocuments() {
    ...
    const [documentsData, setDocumentsData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const fetchDocs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HODDocuments.useCallback[fetchDocs]": async ()=>{
            try {
                ...
                if (res.ok) {
                    ...
                    const mapped = data.map({
                        "HODDocuments.useCallback[fetchDocs].mapped": (d)=>({
                                id: d.id,
                                title: d.title,
                    ...
                    }["HODDocuments.useCallback[fetchDocs].mapped"]);
    ...
    }["HODDocuments.useCallback[fetchDocs]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HODDocuments.useEffect": ()=>{
            fetchDocs();
        }
    }["HODDocuments.useEffect"], [
        fetchDocs
        ...
        "HODDocuments.useMemo[filteredDocs]": ()=>{
            ...
            return documentsData.filter({
                "HODDocuments.useMemo[filteredDocs]": (doc)=>{
                    ...
                    const matchesQ = !q || doc.title.toLowerCase().includes(q) || String(doc.id).toLowerCase().includes(q) || (doc.uploadedBy || "").toLowerCase().includes(q) || (doc.department || "").toLowerCase().includes(q) || (doc.type || "").toLowerCase().includes(q);
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODDocuments.useMemo[stats]": ()=>{
            ...
            const totalDownloads = documentsData.reduce({
                "HODDocuments.useMemo[stats].totalDownloads": (sum, d)=>sum + (d.downloads || 0)
    ...
    const maxDownloads = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODDocuments.useMemo[maxDownloads]": ()=>Math.max(1, ...documentsData.map({
                "HODDocuments.useMemo[maxDownloads]": (d)=>d.downloads || 0
...
_s(HODDocuments, "xZ8lXHNxgAeWrd0YkxpEHMYaM9M=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/calaya-taskly/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$views$2f$dashboards$2f$HOD$2f$HODDocuments$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/calaya-taskly/src/views/dashboards/HOD/HODDocuments.jsx [app-client] (ecmascript)");
"use client";
;
;
function Page() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$views$2f$dashboards$2f$HOD$2f$HODDocuments$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
//# sourceMappingURL=Desktop_calaya-taskly_src_1525bfc2._.js.map