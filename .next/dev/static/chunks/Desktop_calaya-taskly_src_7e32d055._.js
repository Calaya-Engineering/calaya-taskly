...
"[project]/Desktop/calaya-taskly/src/pages/dashboards/HOD/HODEvents.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HODEvents() {
    ...
    const [selectedDate, setSelectedDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [departmentFilter, setDepartmentFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    const now = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODEvents.useMemo[now]": ()=>{
            const sorted = [
                ...eventsData
            ].map({
                "HODEvents.useMemo[now].sorted": (e)=>safeDate(e.startAt)
            }["HODEvents.useMemo[now].sorted"]).filter(Boolean).sort({
                "HODEvents.useMemo[now].sorted": (a, b)=>b.getTime() - a.getTime()
            }["HODEvents.useMemo[now].sorted"]);
    ...
    const departments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODEvents.useMemo[departments]": ()=>[
                'all',
                ...new Set(eventsData.map({
                    "HODEvents.useMemo[departments]": (e)=>e.department
                }["HODEvents.useMemo[departments]"]))
            ]
    }["HODEvents.useMemo[departments]"], []);
    const filteredEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODEvents.useMemo[filteredEvents]": ()=>{
            return eventsData.filter({
                "HODEvents.useMemo[filteredEvents]": (event)=>{
            ...
            }["HODEvents.useMemo[filteredEvents]"]).sort({
                "HODEvents.useMemo[filteredEvents]": (a, b)=>new Date(a.startAt).getTime() - new Date(b.startAt).getTime()
            }["HODEvents.useMemo[filteredEvents]"]);
        }
    }["HODEvents.useMemo[filteredEvents]"], [
        viewMode,
    ...
    const listEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODEvents.useMemo[listEvents]": ()=>{
            if (!selectedDate) return filteredEvents;
            return filteredEvents.filter({
                "HODEvents.useMemo[listEvents]": (e)=>{
    ...
    const overview = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODEvents.useMemo[overview]": ()=>{
            const total = eventsData.length;
            const upcoming = eventsData.filter({
                "HODEvents.useMemo[overview]": (e)=>(safeDate(e.startAt)?.getTime() || 0) >= now.getTime()
            }["HODEvents.useMemo[overview]"]).length;
            const meetings = eventsData.filter({
                "HODEvents.useMemo[overview]": (e)=>e.type === 'MEETING'
            }["HODEvents.useMemo[overview]"]).length;
            const attendees = eventsData.reduce({
                "HODEvents.useMemo[overview].attendees": (sum, e)=>sum + (e.attendees || 0)
            }["HODEvents.useMemo[overview].attendees"], 0);
            return {
                total,
                upcoming,
                meetings,
    ...
    const todayISO = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODEvents.useMemo[todayISO]": ()=>toISODate(now)
    }["HODEvents.useMemo[todayISO]"], [
        now
    ]);
    const todaysEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODEvents.useMemo[todaysEvents]": ()=>eventsData.filter({
                "HODEvents.useMemo[todaysEvents]": (e)=>{
                    const d = safeDate(e.startAt);
                    return d ? toISODate(d) === todayISO : false;
                }
            }["HODEvents.useMemo[todaysEvents]"])
    }["HODEvents.useMemo[todaysEvents]"], [
        todayISO
    ]);
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            [
                                                ...
                                                "F",
                                                "S"
                                            ].map((day, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(HODEvents, "YYeGfts+5Yytac48vqbOB3jwnoI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
__turbopack_context__.k.register(_c3, "HODEvents");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/Desktop/calaya-taskly/src/app/hod-dashboard/events/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/calaya-taskly/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$pages$2f$dashboards$2f$HOD$2f$HODEvents$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/calaya-taskly/src/pages/dashboards/HOD/HODEvents.jsx [app-client] (ecmascript)");
"use client";
;
;
function Page() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$pages$2f$dashboards$2f$HOD$2f$HODEvents$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
//# sourceMappingURL=Desktop_calaya-taskly_src_7e32d055._.js.map