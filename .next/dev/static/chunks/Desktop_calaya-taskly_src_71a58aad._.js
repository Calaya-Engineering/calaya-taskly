...
"[project]/Desktop/calaya-taskly/src/views/dashboards/MDDashboard.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MDDashboard() {
    ...
    const fetchTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MDDashboard.useCallback[fetchTasks]": async ()=>{
            try {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])("/api/tasks?limit=1000");
                if (res.ok) {
    ...
    }["MDDashboard.useCallback[fetchTasks]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MDDashboard.useEffect": ()=>{
            fetchTasks();
        }
    }["MDDashboard.useEffect"], [
        fetchTasks
    ...
    const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MDDashboard.useMemo[summary]": ()=>{
            const totalTasks = tasksData.length;
            const activeJobs = tasksData.filter({
                "MDDashboard.useMemo[summary]": (t)=>t.type === "JOB" && t.status !== "COMPLETED"
            }["MDDashboard.useMemo[summary]"]).length;
            const overdueTasks = tasksData.filter({
                "MDDashboard.useMemo[summary]": (t)=>t.dueDate && new Date(t.dueDate).getTime() < Date.now() && t.status !== "COMPLETED"
            }["MDDashboard.useMemo[summary]"]).length;
            const completedTasks = tasksData.filter({
                "MDDashboard.useMemo[summary]": (t)=>t.status === "COMPLETED"
            }["MDDashboard.useMemo[summary]"]).length;
...
_s(MDDashboard, "I26YLcyTSYzIC9LuK4SwFWlXkRE=");
_c3 = MDDashboard;
var _c, _c1, _c2, _c3;
...
"[project]/Desktop/calaya-taskly/src/views/dashboards/MDDashboard.jsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/Desktop/calaya-taskly/src/views/dashboards/MDDashboard.jsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=Desktop_calaya-taskly_src_71a58aad._.js.map