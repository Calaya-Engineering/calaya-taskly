...
"[project]/Desktop/calaya-taskly/src/views/dashboards/MD/MDActiveJobs.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MDActiveJobs() {
    ...
    const [jobsData, setJobsData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MDActiveJobs.useEffect": ()=>{
            let cancelled = false;
            setLoading(true);
            setError(null);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])("/api/tasks?type=JOB&limit=100").then({
                "MDActiveJobs.useEffect": (res)=>{
                    if (!res.ok) throw new Error("Failed to fetch jobs");
                    return res.json();
                }
            }["MDActiveJobs.useEffect"]).then({
                "MDActiveJobs.useEffect": (tasks)=>{
                    if (!cancelled) {
                        setJobsData(Array.isArray(tasks) ? tasks.map(mapTaskToJob) : []);
                    }
                }
            }["MDActiveJobs.useEffect"]).catch({
                "MDActiveJobs.useEffect": (err)=>{
                    if (!cancelled) setError(err?.message ?? "Failed to load jobs");
                }
            }["MDActiveJobs.useEffect"]).finally({
                "MDActiveJobs.useEffect": ()=>{
    ...
    const departments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MDActiveJobs.useMemo[departments]": ()=>[
                ...
                }["MDActiveJobs.useMemo[departments]"]).filter(Boolean))
            ]
    }["MDActiveJobs.useMemo[departments]"], [
        jobsData
    ]);
    ...
    const overview = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MDActiveJobs.useMemo[overview]": ()=>{
            const active = jobsData.filter({
                "MDActiveJobs.useMemo[overview]": (j)=>j.status === "ACTIVE" || j.status === "IN_PROGRESS"
...
_s(MDActiveJobs, "kuF0u5FTlEU/s2JcrRxyNWciBW0=");
_c3 = MDActiveJobs;
var _c, _c1, _c2, _c3;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/calaya-taskly/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$views$2f$dashboards$2f$MD$2f$MDActiveJobs$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/calaya-taskly/src/views/dashboards/MD/MDActiveJobs.jsx [app-client] (ecmascript)");
"use client";
;
;
function Page() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$views$2f$dashboards$2f$MD$2f$MDActiveJobs$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
//# sourceMappingURL=Desktop_calaya-taskly_src_fb7cb07e._.js.map