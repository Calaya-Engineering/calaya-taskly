        ...
        "MDAnnouncementDetail.useEffect": ()=>{
            ...
            const fetchAnnouncement = {
                "MDAnnouncementDetail.useEffect.fetchAnnouncement": async ()=>{
                    try {
                        setLoading(true);
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])(`/api/announcements/${announcementId}`);
                        if (!res.ok) {
...
//# sourceMappingURL=Desktop_calaya-taskly_src_0497f9a9._.js.map