...
"[project]/Desktop/calaya-taskly/src/views/dashboards/HOD/HODAllTasks.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HODAllTasks() {
    ...
    const fetchTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HODAllTasks.useCallback[fetchTasks]": async ()=>{
            try {
    ...
    }["HODAllTasks.useCallback[fetchTasks]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HODAllTasks.useEffect": ()=>{
            fetchTasks();
        }
    }["HODAllTasks.useEffect"], [
        fetchTasks
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HODAllTasks.useEffect": ()=>{
            ...
            async function connectSSE() {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])("/api/tasks/events");
    ...
    const departments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODAllTasks.useMemo[departments]": ()=>[
                ...new Set(tasksData.map({
                    "HODAllTasks.useMemo[departments]": (t)=>t.department
                }["HODAllTasks.useMemo[departments]"]).filter(Boolean))
            ]
    }["HODAllTasks.useMemo[departments]"], [
        tasksData
    ]);
    ...
    const filteredTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODAllTasks.useMemo[filteredTasks]": ()=>{
            const q = filters.search.trim().toLowerCase();
            return tasksData.filter({
                "HODAllTasks.useMemo[filteredTasks]": (task)=>{
    ...
    const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HODAllTasks.useMemo[summary]": ()=>{
            const total = tasksData.length;
            const inProgress = tasksData.filter({
                "HODAllTasks.useMemo[summary]": (t)=>t.status === "IN_PROGRESS"
            }["HODAllTasks.useMemo[summary]"]).length;
            const overdue = tasksData.filter({
                "HODAllTasks.useMemo[summary]": (t)=>isOverdue(t)
            }["HODAllTasks.useMemo[summary]"]).length;
            const completed = tasksData.filter({
                "HODAllTasks.useMemo[summary]": (t)=>t.status === "COMPLETED"
            }["HODAllTasks.useMemo[summary]"]).length;
...
_s(HODAllTasks, "CERdOsYwV2AFckcb5FSY7c5Pxcg=");
_c3 = HODAllTasks;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "Card");
__turbopack_context__.k.register(_c1, "SectionTitle");
__turbopack_context__.k.register(_c2, "Pill");
__turbopack_context__.k.register(_c3, "HODAllTasks");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/Desktop/calaya-taskly/src/app/hod-dashboard/tasks/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/calaya-taskly/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$views$2f$dashboards$2f$HOD$2f$HODAllTasks$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/calaya-taskly/src/views/dashboards/HOD/HODAllTasks.jsx [app-client] (ecmascript)");
"use client";
;
;
function Page() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$views$2f$dashboards$2f$HOD$2f$HODAllTasks$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
//# sourceMappingURL=Desktop_calaya-taskly_src_9ca09539._.js.map