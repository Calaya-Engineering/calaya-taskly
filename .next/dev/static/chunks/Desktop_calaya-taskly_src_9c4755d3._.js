...
function MDEscalations() {
    ...
    const overview = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MDEscalations.useMemo[overview]": ()=>{
            ...
            const overdue = escalationsData.filter({
                "MDEscalations.useMemo[overview]": (e)=>e.status === "OVERDUE"
            }["MDEscalations.useMemo[overview]"]).length;
            const atRisk = escalationsData.filter({
                "MDEscalations.useMemo[overview]": (e)=>e.status === "AT_RISK"
            }["MDEscalations.useMemo[overview]"]).length;
            const level3 = escalationsData.filter({
                "MDEscalations.useMemo[overview]": (e)=>e.escalationLevel === "LEVEL_3"
            }["MDEscalations.useMemo[overview]"]).length;
            const overdueItems = escalationsData.filter({
                "MDEscalations.useMemo[overview].overdueItems": (e)=>e.overdueDays > 0
            }["MDEscalations.useMemo[overview].overdueItems"]);
            const avgOverdue = overdueItems.length ? Math.round(overdueItems.reduce({
                "MDEscalations.useMemo[overview]": (sum, e)=>sum + e.overdueDays
            }["MDEscalations.useMemo[overview]"], 0) / overdueItems.length) : 0;
            return {
                total,
                overdue,
                atRisk,
    ...
    const handleExtend = (id)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info(`Extending deadline for ${id}`);
    };
    const handleResolve = (id)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Resolving escalation ${id}`);
    };
    const clearFilters = ()=>{
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    overview.level3 > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Pill, {
                                                        tone: "danger",
                                                        children: [
                                                            overview.level3,
                                                            " Escalated to MD"
...
_s(MDEscalations, "XcY614pf+vRJaDjoBVTihSX/fVQ=");
_c3 = MDEscalations;
var _c, _c1, _c2, _c3;
