...
function MDDocuments() {
    ...
    const documentTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MDDocuments.useMemo[documentTypes]": ()=>[
                ...
                ...new Set(documentsData.map({
                    "MDDocuments.useMemo[documentTypes]": (d)=>d.type
                }["MDDocuments.useMemo[documentTypes]"]))
            ]
    }["MDDocuments.useMemo[documentTypes]"], []);
    const scopeTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MDDocuments.useMemo[scopeTypes]": ()=>[
                "All Scopes",
                ...new Set(documentsData.map({
                    "MDDocuments.useMemo[scopeTypes]": (d)=>d.scope
                }["MDDocuments.useMemo[scopeTypes]"]))
            ]
    }["MDDocuments.useMemo[scopeTypes]"], []);
    const departments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MDDocuments.useMemo[departments]": ()=>[
                "all",
                ...new Set(documentsData.map({
                    "MDDocuments.useMemo[departments]": (d)=>d.department
                }["MDDocuments.useMemo[departments]"]))
            ]
    }["MDDocuments.useMemo[departments]"], []);
    const filteredDocs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MDDocuments.useMemo[filteredDocs]": ()=>{
            const q = filters.search.trim().toLowerCase();
            return documentsData.filter({
                "MDDocuments.useMemo[filteredDocs]": (doc)=>{
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MDDocuments.useMemo[stats]": ()=>{
            ...
            const totalDownloads = documentsData.reduce({
                "MDDocuments.useMemo[stats].totalDownloads": (sum, d)=>sum + d.downloads
            }["MDDocuments.useMemo[stats].totalDownloads"], 0);
            const avgSize = total ? (documentsData.reduce({
                "MDDocuments.useMemo[stats]": (sum, d)=>sum + toMB(d.size)
    ...
    const maxDownloads = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MDDocuments.useMemo[maxDownloads]": ()=>Math.max(1, ...documentsData.map({
                "MDDocuments.useMemo[maxDownloads]": (d)=>d.downloads
...
_s(MDDocuments, "42TonjeZY6zMZAd2XOBwQoIoRrQ=");
_c3 = MDDocuments;
var _c, _c1, _c2, _c3;
...
//# sourceMappingURL=Desktop_calaya-taskly_src_d29c5524._.js.map