...
"[project]/Desktop/calaya-taskly/src/app/api/documents/[id]/download/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    let auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthFromRequest"])(req);
    // Fallback: Check for token in query parameter (for standard browser downloads)
    if (!auth) {
        const { searchParams } = new URL(req.url);
        const token = searchParams.get("token");
        if (token) {
            const { verifyAuthToken } = await __turbopack_context__.A("[project]/Desktop/calaya-taskly/src/lib/jwt.ts [app-route] (ecmascript, async loader)");
    ...
    try {
        const doc = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.findUnique({
            where: {
                id: docId
            }
        });
        ...
        if (!doc.fileUrl) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "No file URL associated with this document"
            }, {
                status: 400
            });
        }
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$calaya$2d$taskly$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.update({
            where: {
                id: docId
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8cfc6d4d._.js.map