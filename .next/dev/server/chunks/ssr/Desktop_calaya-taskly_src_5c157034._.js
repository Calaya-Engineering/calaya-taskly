...
function MDCreateTask() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (assignmentType === "HODS" && formData.hods.length === 0) {
            alert("Please select at least one HOD");
            return;
        }
        ...
        if (assignmentType === "MIXED" && formData.hods.length === 0 && formData.staff.length === 0 && formData.departments.length === 0) {
            alert("Please select at least one assignee (department / HOD / staff)");
            return;
        }
        let assigneeIds = [];
...
//# sourceMappingURL=Desktop_calaya-taskly_src_5c157034._.js.map