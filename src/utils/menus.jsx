...
export const HODMenuItems = [
  ...
  { label: "Department Tasks", path: "/hod-dashboard/tasks", icon: <TaskIcon />, badge: "18", group: "Tasks" },
  { label: "My Tasks", path: "/hod-dashboard/my-tasks", icon: <TaskIcon />, badge: "5", group: "Tasks" },
  ...
  { label: "Tenders", path: "/hod-dashboard/tenders", icon: <TenderIcon />, badge: "3", group: "Tenders" },
  { label: "Tender Documents", path: "/hod-dashboard/tender-documents", icon: <DocumentIcon />, badge: "5", group: "Tenders" },
  { label: "Announcements", path: "/hod-dashboard/announcements", icon: <AnnouncementIcon />, group: "Communications" },
  { label: "Approvals", path: "/hod-dashboard/approvals", icon: <ApprovalIcon />, badge: "4", group: "Workflow" },
  { label: "Escalations/Overdue", path: "/hod-dashboard/escalations", icon: <AlertIcon />, badge: "2", group: "Workflow" },
  { label: "Notifications", path: "/hod-dashboard/notifications", icon: <BellIcon />, badge: "8", group: "Account" },
...
export const MDMenuItems = [
  ...
  { label: "Tasks (All)", path: "/md-dashboard/tasks", icon: <TaskIcon />, badge: "24", group: "Tasks" },
  { label: "Active Jobs", path: "/md-dashboard/jobs", icon: <TaskIcon />, badge: "8", group: "Tasks" },
  { label: "Documents", path: "/md-dashboard/documents", icon: <DocumentIcon />, badge: "3", group: "Documents & Reports" },
  { label: "Daily Reports", path: "/md-dashboard/reports", icon: <ReportIcon />, group: "Documents & Reports" },
  { label: "Meetings/Events", path: "/md-dashboard/events", icon: <CalendarIcon />, badge: "2", group: "Calendar" },
  { label: "Tenders", path: "/md-dashboard/tenders", icon: <DocumentIcon />, group: "Tenders" },
  { label: "Tender Documents", path: "/md-dashboard/tender-documents", icon: <DocumentIcon />, badge: "5", group: "Tenders" },
  { label: "Announcements", path: "/md-dashboard/announcements", icon: <AnnouncementIcon />, group: "Communications" },
  { label: "Approvals", path: "/md-dashboard/approvals", icon: <ApprovalIcon />, badge: "7", group: "Workflow" },
  { label: "Escalations/Overdue", path: "/md-dashboard/escalations", icon: <AlertIcon />, badge: "3", group: "Workflow" },
  { label: "Notifications", path: "/md-dashboard/notifications", icon: <BellIcon />, badge: "12", group: "Account" },
...
export const StaffMenuItems = [
  ...
  { label: "My Tasks", path: "/staff-dashboard/tasks", icon: <TaskIcon />, badge: "8", group: "Tasks" },
  ...
  { label: "Tenders", path: "/staff-dashboard/tenders", icon: <TenderIcon />, badge: "3", group: "Tenders" },
  { label: "Tender Documents", path: "/staff-dashboard/tender-documents", icon: <DocumentIcon />, badge: "5", group: "Tenders" },
  { label: "Announcements", path: "/staff-dashboard/announcements", icon: <AnnouncementIcon />, group: "Communications" },
  { label: "Notifications", path: "/staff-dashboard/notifications", icon: <BellIcon />, badge: "5", group: "Account" },
...
export const SecretaryMenuItems = [
  ...
  { label: "Daily Reports Archive", path: "/secretary-dashboard/reports-archive", icon: <ReportIcon />, badge: "24", group: "Documents & Reports" },
  { label: "Task Reports Archive", path: "/secretary-dashboard/task-reports", icon: <DocumentIcon />, badge: "45", group: "Documents & Reports" },
  { label: "Documents", path: "/secretary-dashboard/documents", icon: <DocumentIcon />, group: "Documents & Reports" },
  { label: "Meetings/Events", path: "/secretary-dashboard/events", icon: <CalendarIcon />, badge: "3", group: "Calendar" },
  { label: "Tenders", path: "/secretary-dashboard/tenders", icon: <TenderIcon />, badge: "5", group: "Tenders" },
  { label: "Announcements", path: "/secretary-dashboard/announcements", icon: <AnnouncementIcon />, badge: "3", group: "Communications" },
  { label: "Notifications", path: "/secretary-dashboard/notifications", icon: <BellIcon />, badge: "12", group: "Account" },
