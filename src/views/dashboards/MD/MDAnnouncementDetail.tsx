    ...
    return (
      <Layout menuItems={MDMenuItems} userRole="MD">
        <div className="flex flex-col items-center justify-center p-12 gap-4">
          ...
          <button onClick={() => router.push("/md-dashboard/announcements")} className={btnOutline}>
      ...
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <Link href={`/md-dashboard/edit-announcement/${announcement.id}`}>
                  <button className={btnOutline} style={{ borderColor: "rgba(44,75,155,0.35)", color: "var(--primary-blue)" }}>
                    Edit
                  </button>
                </Link>
                <button className={btnSolid} style={{ backgroundColor: "var(--accent-red)" }} onClick={() => toast.info("Delete announcement")}>
                  Delete
                </button>
                {announcement.read ? (
                  <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              <div className="flex items-start gap-3">
                <div className="w-11 h-11 rounded-2xl bg-blue-50 flex items-center justify-center">{renderNodeWithIcons("ℹ️")}</div>
                <div>
