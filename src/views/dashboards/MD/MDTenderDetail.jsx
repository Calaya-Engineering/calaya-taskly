...
/* ---------- UI helpers (same style as MD dashboards) ---------- */
...
export default function MDTenderDetail() {
  ...
  const docStats = useMemo(() => {
    ...
    return { totalDocs, totalPages, totalSize: "5.6 MB" };
  }, []);
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              <div className="min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2 text-sm text-gray-600">
                  ...
                  <span className="font-semibold">{tenderData.department}</span>
                  <span className="text-gray-400">•</span>
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <Link href={`/md-dashboard/tender-documents/${tenderId || tenderData.id}`}>
                  <button
        ...
        {activeTab === "details" ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="lg:col-span-1 p-6">
              <SectionTitle title="Quick Actions" subtitle="Downloads and sharing" />
...
function Row({ label, value, strong = false }) {
  return (
    <div className="flex items-start justify-between gap-4">
      ...
      <span className={`${strong ? "font-extrabold" : "font-semibold"} text-gray-900 text-right`}>{value}</span>
    </div>
  );
}
