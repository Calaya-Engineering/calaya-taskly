          ...
          {filteredTenders.map((tender) => {
            ...
            return (
              <Card
                ...
                onClick={() => router.push(`/secretary-dashboard/tender/${tender.id}`)}
                role="button"
                tabIndex={0}
              >
                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row lg:flex-col gap-2 lg:w-48 shrink-0">
                    <Link
                      href={`/secretary-dashboard/tender/${tender.id}`}
        ...
        <Card className="p-6 bg-blue-50/30">
          ...
          <div className="mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={index} className="p-4 rounded-2xl border border-gray-200/70 bg-white transition">
