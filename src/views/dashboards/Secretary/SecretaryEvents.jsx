      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredEvents.map((event) => (
            <Card key={event.id} className="overflow-hidden transition cursor-pointer"
                  onClick={() => router.push(`/secretary-dashboard/event/${event.id}`)}>
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <Link href={`/secretary-dashboard/event/${event.id}`} className="flex-1">
                    <button
