            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              <div className="min-w-0">
                ...
                {tenderData?.createdBy ? (
                  <p className="text-xs text-gray-500 mt-2">Created by: {tenderData.createdBy}</p>
                ) : null}
              </div>

              {tenderData ? (
                <div className="flex flex-col sm:flex-row gap-2">
                  <Link href={`/hod-dashboard/tender/edit/${tenderData.dbId}`}>
                    <button
                  ...
                  <Link href={`/hod-dashboard/tender-documents/${tenderData.dbId}`}>
                    <button
              ...
              <SectionTitle
                ...
                action={
                  tenderData.documents?.length ? (
                    <Link href={`/hod-dashboard/tender-documents/${tenderData.dbId}`} className="text-sm font-semibold hover:underline" style={{ color: "var(--primary-blue)" }}>
