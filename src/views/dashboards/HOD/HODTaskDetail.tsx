...
const AssignmentDisplay = ({ task }: { task: TaskData }) => {
  ...
  // Company-wide / public visibility with no specific assignment type
  ...
  // Department-level assignment: show department names only
  ...
  // Specific employees (HODS, STAFF, MIXED): show names + departments
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link href={`/hod-dashboard/edit-task/${taskId}`}>
                  <button
