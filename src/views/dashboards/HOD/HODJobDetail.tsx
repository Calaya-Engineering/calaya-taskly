      ...
      >
        <div
          style={{
            ...
            animation: "hod-job-spin 0.75s linear infinite",
          }}
        />
        <style>{`@keyframes hod-job-spin { to { transform: rotate(360deg); } }`}</style>
...
export default function HODJobDetail() {
        ...
        <div className="space-y-6">
          <Card className="p-12 text-center">
            ...
            <p className="text-gray-600 mt-2">
              No job data available. Select a job from your tasks list.
            </p>
            <button
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link href={`/hod-dashboard/edit-task/${jobId}`}>
                  <button
