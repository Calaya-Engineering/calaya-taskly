...
export default function HODCreateTender() {
  ...
  const heroCopy = useMemo(() => ({
    ...
    subtitle: isEditMode
      ? "Update this tender using the simplified tender structure."
      : "Create a company-wide tender with only the fields still in use.",
  }), [isEditMode]);
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div>
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <Pill tone="info">{formData.status}</Pill>
                </div>
        ...
        <form onSubmit={handleSubmit}>
          <Card className="p-6 md:p-8">
            <SectionTitle
              ...
              subtitle="Department, category, budget, contact information, and requirements have been removed."
            />
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      required
                      className={inputBase}
                      placeholder="e.g., Operations Support Services"
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="rounded-2xl border border-dashed border-gray-300 bg-white p-6">
                      <input
                        ...
                        multiple
                        className="hidden"
                        id="hod-tender-document-upload"
                        onChange={handleFileUpload}
                        accept=".pdf,.doc,.docx,.xls,.xlsx,.csv,.zip,.jpg,.jpeg,.png"
                      />
                      <label htmlFor="hod-tender-document-upload" className="block cursor-pointer text-center">
