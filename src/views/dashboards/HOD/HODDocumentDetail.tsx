...
export default function HODDocumentDetail() {
  ...
  const uploadNewVersion = async (file) => {
    ...
    try {
      ...
      const patchRes = await fetchWithAuth(`/api/documents/${documentData.dbId || documentData.id}`, {
        method: "PATCH",
      ...
      const nextVersion = getNextVersionLabel(documentData.versionLabel);
      setDoc((prev) =>
        prev
          ? {
              ...prev,
  ...
  const handleUploadNewVersion = () => {
    ...
    if (!documentData?.dbId && !documentData?.id) {
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    {documentData.attachedTask ? (
                      <Link href={`/hod-dashboard/task/${documentData.attachedTask}`} className="font-semibold text-blue-600 hover:underline">
                        {documentData.attachedTask}
                      </Link>
                    ) : (
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { icon: "📧", label: "Email Document", onClick: () => toast.info("Email document"), color: "#10B981" },
