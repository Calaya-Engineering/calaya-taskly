...
export default function RequestAccess() {
  ...
  if (submitSuccess) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4"
        ...
        <div className="w-full max-w-md bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 text-center">
          <div className="mb-6">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4"
      ...
      {/* Main Container */}
      <div className="w-full max-w-4xl bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden z-10">
        {/* Decorative Top Accent */}
        <div className="h-2 bg-gradient-to-r from-[#ED3237] via-[#2C4B9B] to-[#6DC6DF]"></div>
        ...
        <div className="p-8 md:p-10">
          ...
          <div className="mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-2">
                Fill out this form to request access to CALAYA TASKLY
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Please explain why you need access to CALAYA TASKLY..."
                rows="4"
                className="w-full rounded-xl border-2 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200"
                style={{
                  borderColor: "#6DC6DF",
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full text-white font-semibold py-3.5 rounded-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
              ...
              <p className="text-center text-sm text-gray-600 mt-4">
                ...
                <Link to="/login" className="font-semibold hover:underline" style={{ color: "#2C4B9B" }}>
                  Sign in here
                </Link>
              </p>
            </div>
