...
const SecretaryMenuItems = [
  ...
  { label: 'My Submissions', path: '/secretary-dashboard/submissions', icon: <ApprovalIcon />, badge: '4' },
...
export default function SecretaryRequest() {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      navigate('/secretary-dashboard/submissions');
    }, 3000);
  };
        ...
        <Card className="overflow-hidden">
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              ...
              <Link to="/secretary-dashboard/submissions">
                <button
                ...
                <div className="space-y-6">
                  ...
                  <div className="mt-8 flex justify-end">
                    <button
                      ...
                      className="px-6 py-3 rounded-2xl font-semibold text-white shadow-sm active:scale-[0.99] transition disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <div className="space-y-6">
                  ...
                  <div className="mt-8 flex justify-between">
                    ...
                    <button
                      ...
                      className="px-8 py-3 rounded-2xl font-semibold text-white shadow-sm active:scale-[0.99] transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
