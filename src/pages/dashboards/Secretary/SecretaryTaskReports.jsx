          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <button
                  onClick={() => alert('Exporting summary...')}
                  className={btnSolid}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-2xl text-sm font-semibold text-white shadow-sm active:scale-[0.99] transition flex items-center gap-1"
                      style={{ backgroundColor: "var(--secondary-blue)" }}
                    >
        ...
        <Card className="p-6">
          ...
          <div className="mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            {departments.map(dept => {
              ...
              return (
                <div key={dept} className="p-4 rounded-2xl border border-gray-200/70 hover:shadow-sm transition">
