        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="mt-4 space-y-3">
                <Link to="/secretary-dashboard/upload-report">
                ...
                <Link to="/secretary-dashboard/tenders">
                  <button className="w-full p-4 rounded-2xl border border-gray-200/70 hover:bg-gray-50 transition text-left">
                    <div className="flex items-center gap-3">
                      <div
                        className="w-10 h-10 rounded-2xl flex items-center justify-center"
                ...
                <Link to="/secretary-dashboard/events">
                  <button className="w-full p-4 rounded-2xl border border-gray-200/70 hover:bg-gray-50 transition text-left">
                    <div className="flex items-center gap-3">
                      <div
                        className="w-10 h-10 rounded-2xl flex items-center justify-center"
            ...
            <Card className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link to="/secretary-dashboard/settings" className="text-sm font-semibold" style={{ color: "var(--primary-blue)" }}>
                  Edit All
                </Link>
              </div>
