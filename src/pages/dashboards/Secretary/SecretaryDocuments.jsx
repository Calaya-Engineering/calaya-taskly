    ...
    <Layout menuItems={SecretaryMenuItems} userRole="Secretary">
      <div className="space-y-6">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="w-full sm:w-auto px-5 py-3 rounded-2xl font-semibold shadow-sm active:scale-[0.99] transition flex items-center justify-center gap-2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6">
          {stats.map((stat) => (
            <Card key={stat.title} className="p-5 hover:shadow-md hover:-translate-y-0.5 transition-all">
            ...
            sortedDocuments.map(doc => (
              <Card key={doc.id} className="p-6 hover:shadow-md transition-all">
                <div className="flex items-start gap-4 mb-4">
                  <div
                    className="w-14 h-14 rounded-2xl flex items-center justify-center text-2xl shrink-0 ring-1 ring-black/5"
                ...
                <div className="flex gap-3">
                  <Link to={`/secretary-dashboard/document/${doc.id}`} className="flex-1">
                    <button
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 rounded-xl font-semibold text-white shadow-sm hover:shadow-md transition active:scale-[0.99] flex items-center justify-center gap-2"
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div
                      className="w-10 h-10 rounded-xl flex items-center justify-center ring-1 ring-black/5"
                      style={{ backgroundColor: "rgba(109, 198, 223, 0.18)" }}
                    >
                      <span className="text-lg">📁</span>
                    </div>
                    ...
                    <div key={month} className="space-y-1">
                      ...
                      <div className="h-2 rounded-full bg-gray-100 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${percentage}%`,
                            background: "linear-gradient(90deg, var(--secondary-blue) 0%, #4FD1C5 100%)",
                          }}
                        />
                      </div>
                    </div>
                ...
                <form onSubmit={handleSubmitDocument} className="space-y-6">
                  ...
                  <div className="bg-gray-50 rounded-xl p-6">
                    ...
                    <div className="border-2 border-dashed rounded-xl p-8 text-center hover:border-blue-500 transition-colors"
                      ...
                      <label htmlFor="document-file-upload" className="cursor-pointer">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center ring-1 ring-black/5"
                             style={{ backgroundColor: "rgba(109, 198, 223, 0.18)" }}>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <button
                            ...
                            className="px-4 py-2 rounded-xl font-semibold text-white shadow-sm transition active:scale-[0.99]"
                            style={{ backgroundColor: 'var(--secondary-blue)' }}
                          >
                            Add
                          </button>
                  ...
                  <div className="flex justify-end gap-4 pt-6 border-t">
                    ...
                    <button
                      ...
                      className={`px-6 py-3 rounded-xl font-semibold text-white shadow-sm transition active:scale-[0.99] ${
