...
All staff must acknowledge receipt of these updated protocols by December 31, 2024. Training sessions will be conducted next week.`,
  ...
  const handleDownloadAll = () => alert('Downloading all attachments...');
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              <div className="flex items-start gap-3">
                <button
                  onClick={() => navigate("/secretary-dashboard/announcements")}
                    ...
                    <div className="mt-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {announcement.attachments.map((att) => (
                          <div
                            key={att.id}
                            className="p-4 rounded-2xl border border-gray-200/70 bg-white hover:shadow-sm transition flex items-center justify-between"
                          >
                            <div className="flex items-center gap-3">
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="mt-4 space-y-3">
                <Link to="/secretary-dashboard/announcement/ANN-001">
                ...
                <Link to="/secretary-dashboard/announcement/ANN-002">
                  <div className="p-4 rounded-2xl border border-gray-200/70 hover:bg-gray-50 transition cursor-pointer">
                ...
                <Link to="/secretary-dashboard/announcement/ANN-006">
                  <div className="p-4 rounded-2xl border border-gray-200/70 hover:bg-gray-50 transition cursor-pointer">
