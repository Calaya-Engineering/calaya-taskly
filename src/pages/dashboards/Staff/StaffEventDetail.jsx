          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              <div className="flex items-start gap-3">
                <button
                  onClick={() => navigate("/staff-dashboard/events")}
            ...
            <Card className="p-6">
              ...
              <div className="mt-4 space-y-3">
                <div 
                  ...
                  onClick={() => navigate('/staff-dashboard/event/EVT-002')}
                >
                ...
                <div 
                  className="p-4 rounded-2xl border border-gray-200/70 hover:bg-gray-50 transition cursor-pointer"
                  onClick={() => navigate('/staff-dashboard/event/EVT-003')}
                >
                ...
                <div 
                  className="p-4 rounded-2xl border border-gray-200/70 hover:bg-gray-50 transition cursor-pointer"
                  onClick={() => navigate('/staff-dashboard/event/EVT-005')}
                >
