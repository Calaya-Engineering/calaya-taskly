          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              <div className="flex items-start gap-3">
                <button
                  onClick={() => navigate("/staff-dashboard/announcements")}
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                <Link to="/staff-dashboard/announcement/ANN-002">
                ...
                <Link to="/staff-dashboard/announcement/ANN-003">
                  <div className="p-3 rounded-2xl border border-gray-200/70 hover:bg-gray-50 transition cursor-pointer">
                ...
                <Link to="/staff-dashboard/announcement/ANN-004">
                  <div className="p-3 rounded-2xl border border-gray-200/70 hover:bg-gray-50 transition cursor-pointer">
