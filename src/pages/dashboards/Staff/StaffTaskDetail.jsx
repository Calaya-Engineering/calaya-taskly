            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  disabled={isUpdating}
                  className="px-5 py-3 rounded-2xl font-semibold text-white shadow-sm active:scale-[0.99] transition disabled:opacity-50 disabled:cursor-not-allowed"
                      ...
                      <div className="mt-4 space-y-4">
                        ...
                        <div className="flex justify-end">
                          <button
                            ...
                            disabled={isUpdating}
                            className="px-5 py-2.5 rounded-2xl text-sm font-semibold text-white shadow-sm active:scale-[0.99] transition disabled:opacity-50"
                            style={{ backgroundColor: "var(--secondary-blue)" }}
                          >
