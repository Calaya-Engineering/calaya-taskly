      ...
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <Link to="/secretary-dashboard/task-reports">
        ...
        <Card className="p-6">
          ...
          <div className="mt-5 grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link to="/secretary-dashboard/reports-archive">
              <button className="w-full p-5 rounded-2xl border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50/30 transition-all text-center">
                <div className="text-3xl mb-2">📚</div>
                <p className="font-extrabold text-sm" style={{ color: "var(--primary-blue)" }}>View Archive</p>
              </button>
            </Link>
            <Link to="/secretary-dashboard/announcements">
              <button className="w-full p-5 rounded-2xl border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50/30 transition-all text-center">
                <div className="text-3xl mb-2">📢</div>
          ...
          <Card className="p-6">
            ...
            <div className="mt-5 space-y-3">
              {recentReports.map((report, index) => (
                <Link
                  key={index}
                  to={`/secretary-dashboard/reports-archive?report=${report.date}`}
          ...
          <Card className="p-6">
            ...
            <div className="mt-5 space-y-3">
              {recentAnnouncements.map((announcement, index) => (
                <Link
                  key={index}
                  to={`/secretary-dashboard/announcement/${announcement.title.replace(/\s+/g, '-')}`}
                  className="block p-4 rounded-2xl border border-gray-200/70 hover:bg-gray-50 transition"
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="p-6">
            ...
            <div className="mt-5 space-y-3">
              {recentTaskReports.map((report, index) => (
                <Link
                  key={index}
                  to={`/secretary-dashboard/task-reports?report=${report.task}`}
                  className="block p-4 rounded-2xl border border-gray-200/70 hover:bg-gray-50 transition"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
          ...
          <Card className="p-6">
            <SectionTitle
              ...
              action={
                <Link to="/secretary-dashboard/notifications">
                  <button className={btnSolid} style={{ backgroundColor: "var(--secondary-blue)" }}>
                    See All
                  </button>
                </Link>
        ...
        <Card className="p-6">
          ...
          <div className="mt-5 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl border border-gray-200/70 text-center hover:shadow-sm transition">
