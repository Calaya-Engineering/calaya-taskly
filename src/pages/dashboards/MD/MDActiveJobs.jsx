...
const jobsData = [
  { id: "JOB-001", title: "Pipeline Inspection Project", project: "Site A - Pipeline", department: "Technical", supervisor: "Mike Johnson", status: "ACTIVE", startDate: "2024-12-01", endDate: "2024-12-31", progress: 75, priority: "CRITICAL" },
  { id: "JOB-002", title: "Safety System Upgrade", project: "Main Facility", department: "HSE", supervisor: "Sarah Smith", status: "ACTIVE", startDate: "2024-12-05", endDate: "2024-12-28", progress: 60, priority: "HIGH" },
  { id: "JOB-003", title: "Workshop Equipment Overhaul", project: "Central Workshop", department: "Workshop", supervisor: "Robert Chen", status: "ACTIVE", startDate: "2024-12-10", endDate: "2025-01-15", progress: 40, priority: "MEDIUM" },
  { id: "JOB-004", title: "Logistics Fleet Maintenance", project: "All Vehicles", department: "Logistics", supervisor: "Lisa Wang", status: "ACTIVE", startDate: "2024-12-03", endDate: "2024-12-20", progress: 85, priority: "HIGH" },
  { id: "JOB-005", title: "IT Infrastructure Migration", project: "Data Center", department: "Technical", supervisor: "Alex Turner", status: "ACTIVE", startDate: "2024-12-15", endDate: "2025-01-10", progress: 25, priority: "CRITICAL" },
  { id: "JOB-006", title: "Legal Compliance Audit", project: "Company-wide", department: "Legal", supervisor: "David Kim", status: "ON_HOLD", startDate: "2024-12-01", endDate: "2024-12-30", progress: 50, priority: "HIGH" },
];
...
export default function MDActiveJobs() {
  ...
  const departments = useMemo(() => ["all", ...new Set(jobsData.map((j) => j.department))], []);
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link to="/md-dashboard/create-task?type=JOB">
                  <button
        ...
        {view === "cards" ? (
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            {filteredJobs.map((job) => (
              <Link key={job.id} to={`/md-dashboard/task/${job.id}`} className="group">
                  ...
                  {filteredJobs.map((job) => (
                    <tr key={job.id} className="hover:bg-gray-50/70 transition">
                      ...
                      <td className="px-5 py-3 text-right whitespace-nowrap">
                        <Link to={`/md-dashboard/task/${job.id}`}>
                          <button
