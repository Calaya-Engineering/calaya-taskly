...
const escalationsData = [
  ...
  },
  {
    ...
    status: "AT_RISK",
    priority: "CRITICAL",
    assignedTo: "Technical HOD",
    comments: 5,
    lastUpdate: "2024-12-14T11:45:00",
  },
  {
    id: "ESC-004",
    ...
    status: "AT_RISK",
    priority: "HIGH",
    assignedTo: "Workshop HOD",
    comments: 1,
    lastUpdate: "2024-12-14T09:20:00",
  },
  {
    id: "ESC-005",
    ...
    assignedTo: "Managing Director",
    comments: 4,
    lastUpdate: "2024-12-13T17:30:00",
  },
];
...
export default function MDEscalations() {
  ...
  const handleExtend = (id) => {
    alert(`Extending deadline for ${id}`);
  };

  const handleResolve = (id) => {
    alert(`Resolving escalation ${id}`);
  };
        ...
        {view === "cards" ? (
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            {filteredEscalations.map((escalation) => (
              <Card key={escalation.id} className="p-6 hover:shadow-md hover:-translate-y-0.5 transition-all">
                ...
                <div className="mt-6 flex items-center gap-2">
                  <Link to={`/md-dashboard/task/${escalation.taskId}`} className="flex-1">
                    <button
                    ...
                    <tr key={escalation.id} className="hover:bg-gray-50/70 transition">
                      ...
                      <td className="px-5 py-3 text-right whitespace-nowrap">
                        <div className="flex items-center justify-end gap-2">
                          <Link to={`/md-dashboard/task/${escalation.taskId}`}>
                            <button
