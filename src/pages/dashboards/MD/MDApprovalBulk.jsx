...
export default function MDApprovalBulk() {
  ...
  const handleBulkApprove = () => {
    alert(`Approving ${selectedItems.length} items${bulkComment ? ` with comment: ${bulkComment}` : ''}`);
  };

  const handleBulkReject = () => {
    alert(`Rejecting ${selectedItems.length} items${bulkComment ? ` with comment: ${bulkComment}` : ''}`);
  };
        ...
        <Card className="overflow-hidden">
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              ...
              <Link to="/md-dashboard/approvals">
                <button 
