...
const hodUsers = [
  { id: 1, name: "John Smith", department: "Technical", role: "HOD", email: "hod.technical@company.com" },
  { id: 2, name: "David Chen", department: "Workshop", role: "HOD", email: "hod.workshop@company.com" },
  { id: 3, name: "Maria Garcia", department: "HSE", role: "HOD", email: "hod.hse@company.com" },
  { id: 4, name: "Robert Lee", department: "Logistics", role: "HOD", email: "hod.logistics@company.com" },
  { id: 5, name: "Sarah Johnson", department: "Accounts", role: "HOD", email: "hod.accounts@company.com" },
  { id: 6, name: "Patricia Davis", department: "HR", role: "HOD", email: "hod.hr@company.com" },
  { id: 7, name: "James Wilson", department: "Contract and Procurement", role: "HOD", email: "hod.procurement@company.com" },
  { id: 8, name: "Lisa Wang", department: "Legal and Compliances", role: "HOD", email: "hod.legal@company.com" },
];

const staffUsers = [
  { id: 101, name: "John Doe", department: "Technical", role: "Staff", email: "john.doe@company.com" },
  { id: 102, name: "Mike Johnson", department: "Technical", role: "Staff", email: "mike.johnson@company.com" },
  { id: 103, name: "Alex Turner", department: "Technical", role: "Staff", email: "alex.turner@company.com" },
  { id: 104, name: "Sarah Smith", department: "HSE", role: "Staff", email: "sarah.smith@company.com" },
  { id: 105, name: "Robert Chen", department: "Workshop", role: "Staff", email: "robert.chen@company.com" },
  { id: 106, name: "Emma Wilson", department: "Technical", role: "Staff", email: "emma.wilson@company.com" },
  { id: 107, name: "Michael Brown", department: "Logistics", role: "Staff", email: "michael.brown@company.com" },
  { id: 108, name: "Lisa Wang", department: "Logistics", role: "Staff", email: "lisa.wang@company.com" },
  { id: 109, name: "David Kim", department: "Legal and Compliances", role: "Staff", email: "david.kim@company.com" },
  { id: 110, name: "James Miller", department: "HR", role: "Staff", email: "james.miller@company.com" },
];
          ...
          <form onSubmit={handleSubmit}>
                    ...
                    <div className="xl:col-span-2 space-y-6">
                      <div className="rounded-2xl border border-gray-200/70 p-5">
                        ...
                        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                          {[
                            { id: "DEPARTMENT", label: "Departments", icon: "🏢", desc: "Assign to entire departments" },
                            { id: "HODS", label: "HODs Only", icon: "👔", desc: "Assign to department heads" },
                            { id: "STAFF", label: "Staff Only", icon: "👥", desc: "Assign to individual staff" },
                            { id: "MIXED", label: "Mixed", icon: "🔄", desc: "Combine departments, HODs & staff" },
                          ].map((t) => {
                        ...
                        <div className="mt-4 space-y-4">
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2">
                                {formData.departments.map((d) => (
                                  <span key={d} className="px-3 py-1 rounded-2xl text-xs font-semibold bg-blue-50 text-blue-700 ring-1 ring-blue-100">
                                    🏢 {d}
                                  </span>
                                ))}
                              </div>
                          ...
                          {formData.hods.length > 0 ? (
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2">
                                {formData.hods.map((h) => (
                                  <span key={h.id} className="px-3 py-1 rounded-2xl text-xs font-semibold bg-purple-50 text-purple-700 ring-1 ring-purple-100">
                                    👔 {h.name} ({h.department})
                                  </span>
                                ))}
                              </div>
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2">
                                {formData.staff.map((s) => (
                                  <span key={s.id} className="px-3 py-1 rounded-2xl text-xs font-semibold bg-emerald-50 text-emerald-700 ring-1 ring-emerald-100">
                                    👤 {s.name} ({s.department})
                                  </span>
                                ))}
                              </div>
            ...
            <div className="px-6 md:px-8 py-4 border-t border-gray-200/70 bg-white flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <div className="flex gap-2">
                ...
                {activeTab === "preview" ? (
                  <Link to="/md-dashboard/tasks" className="hidden">
