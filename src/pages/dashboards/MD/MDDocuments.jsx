...
const documentsData = [
  { id: "DOC-001", title: "Safety Audit Report Q4", type: "Report", department: "HSE", uploadedBy: "Sarah Smith", date: "2024-12-15", size: "2.4 MB", scope: "PUBLIC", downloads: 42 },
  { id: "DOC-002", title: "Pipeline Inspection Guidelines", type: "Procedure", department: "Technical", uploadedBy: "Mike Johnson", date: "2024-12-14", size: "4.1 MB", scope: "ALL_HODS", downloads: 28 },
  { id: "DOC-003", title: "Workshop Maintenance Log", type: "Log", department: "Workshop", uploadedBy: "Robert Chen", date: "2024-12-13", size: "1.2 MB", scope: "SPECIFIC_DEPARTMENTS", downloads: 15 },
  { id: "DOC-004", title: "Legal Compliance Certificate", type: "Certificate", department: "Legal", uploadedBy: "David Kim", date: "2024-12-12", size: "3.7 MB", scope: "SPECIFIC_HODS", downloads: 8 },
  { id: "DOC-005", title: "Financial Quarter Summary", type: "Financial", department: "Accounts", uploadedBy: "James Wilson", date: "2024-12-11", size: "5.2 MB", scope: "PRIVATE", downloads: 3 },
  { id: "DOC-006", title: "HR Policy Handbook 2024", type: "Policy", department: "HR", uploadedBy: "Maria Garcia", date: "2024-12-10", size: "8.9 MB", scope: "PUBLIC", downloads: 56 },
  { id: "DOC-007", title: "IT Security Protocols", type: "Security", department: "Technical", uploadedBy: "Alex Turner", date: "2024-12-09", size: "2.1 MB", scope: "ALL_HODS", downloads: 31 },
  { id: "DOC-008", title: "Logistics Route Maps", type: "Map", department: "Logistics", uploadedBy: "Lisa Wang", date: "2024-12-08", size: "6.5 MB", scope: "SPECIFIC_DEPARTMENTS", downloads: 19 },
];
        ...
        {view === "cards" ? (
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {filteredDocs.map((doc) => (
              <Link key={doc.id} to={`/md-dashboard/document/${doc.id}`} className="group">
                  ...
                  {filteredDocs.map((doc) => (
                    <tr key={doc.id} className="hover:bg-gray-50/70 transition">
                      ...
                      <td className="px-4 py-2.5 text-right whitespace-nowrap">
                        <Link to={`/md-dashboard/document/${doc.id}`}>
                          <button
