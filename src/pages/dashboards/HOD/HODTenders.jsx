          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <Link to="/hod-dashboard/tenders/create">
                  <button
                ...
                <Link to="/hod-dashboard/tender-documents">
                  <button
          ...
          <div className="mt-5 grid grid-cols-1 lg:grid-cols-2 gap-5">
            {filtered.map((t) => {
              ...
              return (
                <div
                  key={t.id}
                  className="p-5 rounded-2xl border border-gray-200/70 hover:shadow-md transition bg-white cursor-pointer relative"
                  onClick={() => navigate(`/hod-dashboard/tender/${t.id}`)}
                  role="button"
                  tabIndex={0}
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex gap-1 shrink-0">
                      <Link to={`/hod-dashboard/tender/edit/${t.id}`} onClick={(e) => e.stopPropagation()}>
                        <button
