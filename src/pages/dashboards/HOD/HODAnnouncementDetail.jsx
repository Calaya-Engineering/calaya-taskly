          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              <div className="flex items-start gap-3">
                <button
                  onClick={() => navigate("/hod-dashboard/announcements")}
                    ...
                    <div className="mt-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {announcement.attachments.map((att) => (
                          <div
                            key={att.id}
                            className="p-4 rounded-2xl border border-gray-200/70 bg-white flex items-center justify-between hover:shadow-sm transition"
                          >
                  ...
                  <div className="space-y-3">
                    {announcement.pendingAcknowledgements.map((user, index) => (
                      <div key={index} className="p-4 rounded-2xl border border-amber-200 bg-amber-50 flex items-center justify-between">
                        ...
                        <button
                          onClick={() => alert(`Reminder sent to ${user.name}`)}
            ...
            <Card className="p-6">
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  onClick={() => alert("Deleting announcement...")}
                  type="button"
                >
