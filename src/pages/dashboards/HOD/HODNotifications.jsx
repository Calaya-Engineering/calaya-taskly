...
const notificationsData = [
  {
    ...
    message: "You have been assigned a new task: Pipeline Safety Inspection",
    time: "10 minutes ago",
    timestamp: "2024-12-10T09:30:00",
    read: false,
    link: "/hod-dashboard/task/TASK-2024-00123",
    priority: "HIGH",
    sender: {
      name: "System",
      avatar: "🤖",
  ...
  },
  {
    ...
    message: "Alex Johnson has submitted a task completion report for your approval",
    time: "2 hours ago",
    timestamp: "2024-12-10T07:45:00",
    read: false,
  ...
  },
  {
    ...
    message: "Maria Garcia uploaded a new safety protocol document to your department",
    time: "1 day ago",
    timestamp: "2024-12-09T14:20:00",
    read: true,
    link: "/hod-dashboard/document/DOC-002",
    priority: "NORMAL",
    sender: {
      name: "Maria Garcia",
      avatar: "MG",
  ...
  },
  {
    ...
    type: "TASK_OVERDUE",
    title: "Task Overdue",
    message: 'Task "Workshop Equipment Calibration" is now 7 days overdue',
    time: "2 days ago",
    timestamp: "2024-12-08T11:00:00",
    read: false,
    link: "/hod-dashboard/task/TASK-2024-00125",
    priority: "HIGH",
    sender: {
      name: "System Alert",
      avatar: "⚠️",
  ...
  },
  {
    ...
    message: "You are invited to Technical Department Quarterly Review on Dec 20",
    time: "3 days ago",
    timestamp: "2024-12-07T16:30:00",
    read: true,
    link: "/hod-dashboard/event/EVT-001",
    priority: "NORMAL",
    sender: {
      name: "Calendar",
      avatar: "📅",
  ...
  },
  {
    ...
    message: "New safety protocol updates have been announced by HSE Department",
    time: "4 days ago",
    timestamp: "2024-12-06T10:15:00",
    read: true,
    link: "/hod-dashboard/announcement/ANN-002",
    priority: "IMPORTANT",
    sender: {
      name: "HSE Department",
      avatar: "📢",
  ...
  },
  {
    ...
    message: "Tender for Offshore Platform Maintenance closes in 7 days",
    time: "5 days ago",
    timestamp: "2024-12-05T09:00:00",
    read: false,
    link: "/hod-dashboard/tender/TEN-2024-001",
    priority: "URGENT",
    sender: {
      name: "Procurement",
      avatar: "💰",
  ...
  },
  {
    ...
    message: "David Chen submitted monthly workshop operations report",
    time: "1 week ago",
    timestamp: "2024-12-03T13:45:00",
    read: true,
  ...
  },
  {
    ...
    message: 'Task "Safety Audit" has been escalated to your attention',
    time: "1 hour ago",
    timestamp: "2024-12-10T08:30:00",
    read: false,
    link: "/hod-dashboard/task/TASK-2024-00126",
    priority: "URGENT",
    sender: {
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="w-full sm:w-auto px-5 py-3 rounded-2xl font-semibold text-white shadow-sm active:scale-[0.99] transition"
          ...
          <Card className="border-red-200 bg-red-50/30 overflow-hidden">
            <div className="p-4 flex items-center justify-between">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl font-semibold text-sm bg-red-500 text-white hover:bg-red-600 transition shadow-sm"
              >
                View Urgent
              </button>
            </div>
                    ...
                    return (
                      ...
                      >
                        <Link to={notification.link} onClick={() => markAsRead(notification.id)}>
                          <div className="p-6">
                            <div className="flex items-start gap-4">
                              {/* Icon */}
                              <div
                                className={`w-12 h-12 rounded-2xl flex items-center justify-center ring-1 ring-black/5 shrink-0 ${style.bg}`}
                              >
                        ...
                        <button
                          ...
                          className="absolute top-4 right-4 p-2 bg-white rounded-xl shadow-sm opacity-0 group-hover:opacity-100 transition-opacity hover:bg-red-50"
                        >
