...
export default function HODDailyReports() {
  ...
  const handleSubmitReport = () => {
    ...
    setDailyReports([...newReports, ...dailyReports]);
    setIsModalOpen(false);
    sessionStorage.setItem(STORAGE_KEYS.IS_MODAL_OPEN, JSON.stringify(false));
    resetForm();
    alert(`Daily reports submitted successfully for ${selectedDepartments.length} department(s)!`);
  };
      ...
      <div className="space-y-6">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`p-3 rounded-2xl text-xl transition ${
                      viewMode === 'list' ? 'bg-white shadow-sm' : 'bg-gray-50 hover:bg-gray-100'
                    }`}
                  ...
                  <button
                    ...
                    className={`p-3 rounded-2xl text-xl transition ${
                      viewMode === 'calendar' ? 'bg-white shadow-sm' : 'bg-gray-50 hover:bg-gray-100'
                    }`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {MANAGED_DEPARTMENTS.map(dept => {
            ...
            return (
              <Card key={dept} className="p-6 hover:shadow-md transition">
