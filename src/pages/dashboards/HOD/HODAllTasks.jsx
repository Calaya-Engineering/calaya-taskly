          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link to="/hod-dashboard/create-task">
                  <button
                  ...
                  <tr key={task.id} className="hover:bg-gray-50/70 transition">
                    <td className="px-5 py-3">
                      <div className="flex items-start gap-3">
                        <div
                          className="w-9 h-9 rounded-2xl flex items-center justify-center ring-1 ring-black/5 shrink-0"
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center justify-end gap-2">
                        <Link to={`/hod-dashboard/task/${task.id}`}>
                          <button
