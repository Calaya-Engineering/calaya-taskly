...
// Departments that HOD can manage
const MANAGED_DEPARTMENTS = ['Technical', 'Workshop', 'HSE'];

const departmentMembers = {
  'Technical': [
    { id: 1, name: 'Alex Johnson', role: 'Senior Engineer' },
    { id: 2, name: 'Michael Brown', role: 'Engineer' },
    { id: 3, name: 'Sarah Lee', role: 'Technician' },
    { id: 4, name: 'David Wilson', role: 'Junior Engineer' },
    { id: 5, name: 'Emma Wilson', role: 'Engineer' },
  ],
  'Workshop': [
    { id: 6, name: 'Robert Chen', role: 'Workshop Supervisor' },
    { id: 7, name: 'Emma Davis', role: 'Mechanic' },
    { id: 8, name: 'James Smith', role: 'Technician' },
    { id: 9, name: 'Lisa Taylor', role: 'Fabricator' },
  ],
  'HSE': [
    { id: 10, name: 'Maria Garcia', role: 'HSE Officer' },
    { id: 11, name: 'John Anderson', role: 'Safety Inspector' },
    { id: 12, name: 'Patricia Miller', role: 'Environmental Officer' },
    { id: 13, name: 'Thomas Martinez', role: 'Safety Assistant' },
  ],
};
...
export default function HODCreateTask() {
  ...
  const handleDepartmentToggle = (department) => {
    setFormData(prev => {
      ...
      const newAssignees = prev.selectedAssignees.filter(assignee => {
        const member = getAllMembers().find(m => m.name === assignee.name);
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Task created successfully and assigned to ${formData.selectedAssignees.length} team member(s)!`);
    navigate('/hod-dashboard/tasks');
  };
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5">
              <div>
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <Pill tone="purple">HOD: {MANAGED_DEPARTMENTS.join(' • ')}</Pill>
                </div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  onClick={() => navigate("/hod-dashboard/tasks")}
                >
                  Cancel
                </button>
              </div>
