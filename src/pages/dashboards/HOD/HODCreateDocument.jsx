...
export default function HODCreateDocument() {
  ...
  const handleSubmit = (e) => {
    ...
    navigate("/hod-dashboard/documents");
  };
                    ...
                    <div className="rounded-2xl border border-gray-200/70 p-5">
                      ...
                      <div className="mt-4 border-2 border-dashed border-gray-200 rounded-2xl p-8 text-center hover:border-blue-200 transition">
                        ...
                        <label htmlFor="file-upload" className="cursor-pointer">
                          ...
                          <p className="text-sm text-gray-500">Max 100MB per file • PDF, DOCX, XLSX, JPG, PNG</p>
                        </label>
                      </div>
                            ...
                            {files.map((file, idx) => (
                              <div key={`${file.name}-${idx}`} className="flex items-center justify-between gap-3 p-3 rounded-2xl border border-gray-200/70 bg-white">
                                <div className="flex items-center gap-3 min-w-0">
                                  <div className="w-10 h-10 rounded-2xl flex items-center justify-center ring-1 ring-black/5 shrink-0" style={{ backgroundColor: "rgba(44, 75, 155, 0.08)" }}>
